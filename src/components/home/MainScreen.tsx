...
const MainScreen = () => {
    ...
    return (
        <div className="relative">
            <div className="h-[472px] bg-cover bg-center relative" style={{ backgroundImage: `url(${API_URL}${mainBanner})` }}>
                <div className="absolute inset-0 bg-[#2B2A29] opacity-70"></div>
                <div className="absolute inset-0 flex items-center justify-center flex-col">
                    <h1 className="text-white text-3xl font-bold text-center">
                        <span className="text-4xl font-museo">{titlePart1}</span>
                        <br />
                        <span className="text-3xl font-museo">{titlePart2}</span>
                    </h1>
                    <div className="flex gap-[3.5px] items-center mt-24">
