...
export const fetchHomeData = async () => {
    try {
      const response = await axiosInstanse.get(`${API_URL}/api/glavnaya?populate=About.Photo&populate=Greetings.Photo&populate=Metadata&populate=Mortgage.Photos&populate=recomendations.Icon`);
